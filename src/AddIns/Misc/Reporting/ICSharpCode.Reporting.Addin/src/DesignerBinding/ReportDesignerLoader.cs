...
namespace ICSharpCode.Reporting.Addin.DesignerBinding
{
	...
	public class ReportDesignerLoader : BasicDesignerLoader
	{
		...
		public override void BeginLoad(IDesignerLoaderHost host)
		{
			...
			this.host = host;
			host.AddService(typeof(ComponentSerializationService),
				new CodeDomComponentSerializationService((IServiceProvider)host));
			host.AddService(typeof(IDesignerSerializationService),
				new DesignerSerializationService((IServiceProvider)host));
			base.BeginLoad(host);
		}
