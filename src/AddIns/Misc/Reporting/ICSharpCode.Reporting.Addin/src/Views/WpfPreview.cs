...
namespace ICSharpCode.Reporting.Addin.Views
{
	...
	public class WpfPreview : AbstractSecondaryViewContent
	{
		...
		ICSharpCode.Reporting.WpfReportViewer.WpfReportViewer viewer =
			new ICSharpCode.Reporting.WpfReportViewer.WpfReportViewer();
		...
		protected override void LoadFromPrimary()
		{
			...
			var previewViewModel =
				new PreviewViewModel(reportingFactory.ReportModel.ReportSettings, reportCreator.Pages);
